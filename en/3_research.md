...
- [Topological Defects in Physics](/files/research/Topological_Defects_in_Physics.pdf){: target="_blank"}, a pedagogically written overview essay (2017)
...
1. Brbić, M.; **Rožić, E.**; Podnar Žarko, I. [Recommendation of YouTube Videos](/files/research/Recommendation_of_YouTube_videos.pdf){: target="_blank"}. Proceedings of the 35<sup>th</sup> MIPRO International Convention, Opatija, Croatia (pp. 1775 -- 1779), IEEE Xplore (2012)
{: reversed="reversed" id="papers_ol" style="display: none;"}

### Master Theses
Physics: [On Different Thermodynamical Pictures of Ensembles of Complex Networks](/files/research/Eugen_Rozic_MSc_thesis_Physics.pdf){: target="_blank"}
...
ICT: [A Dynamic and Elastic Publish-Subscribe Service for the Cloud Environment](/files/research/Eugen_Rozic_MSc_thesis_ICT.pdf){: target="_blank"}
